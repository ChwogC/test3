...
function downloadQuote() {
  ...
  const quoteStyle = getComputedStyle(document.getElementById('quote'));
  // Remove author styling
  // const authorStyle = getComputedStyle(document.getElementById('author')); 
  ...
  // Remove author from canvas
  // ctx.font = authorStyle.font;
  // ctx.fillStyle = authorStyle.color;
  // ctx.shadowColor = authorStyle.textShadow;
